...
const calculateProtectionSettings = (inputs) => {
  const {
    ...
    zonasConfig,    // Legacy / fallback geral
    zonasConfigA,   // Zonas específicas Terminal A (opcional)
    zonasConfigB    // Zonas específicas Terminal B (opcional)
  } = inputs;

  // Defaults caso nada seja fornecido
  const zonasDefault = {
    z1_percent: 80, z2_percent: 120, z3_percent: 150, z4_percent: 20,
    z1_tempo: 0, z2_tempo: 400, z3_tempo: 1200, z4_tempo: 1000,
    z4_habilitada: true, z4_reversa: true
  };
...
function SEPApp() {
  ...
  const [zonasTerminalA, setZonasTerminalA] = useState({...defaultZonas});
  const [zonasTerminalB, setZonasTerminalB] = useState({...defaultZonas});
  ...
  const aplicarPadraoZonas = (norma) => {
    ...
    const novasZonas = {
      z1_percent: padrao.z1, z2_percent: padrao.z2, z3_percent: padrao.z3, z4_percent: padrao.z4,
      z1_tempo: padrao.z1t, z2_tempo: padrao.z2t, z3_tempo: padrao.z3t, z4_tempo: padrao.z4t,
      z4_habilitada: true, z4_reversa: true
    };
  ...
  const calcularProtecao = useCallback(() => {
    ...
    const inputs = {
      ...
      zonasConfig: zonasTerminalA,      // Legacy fallback
      zonasConfigA: zonasTerminalA,     // Zonas específicas do Terminal A
        ...
        {activeTab === 1 && (
          <>
            ...
            <div className="panel">
              ...
              {/* SELETOR DE TERMINAL A/B + VINCULAR */}
              <div style={{ padding: '16px 20px', background: '#0d1117', borderBottom: '1px solid #30363d', display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
                <div style={{ display: 'flex', gap: '6px', background: '#161b22', padding: '4px', borderRadius: '10px', border: '1px solid #30363d' }}>
                  <button
                ...
                <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', marginLeft: 'auto' }}>
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (novoVinculo) {
                        setZonasTerminalB({...zonasTerminalA});
                  ...
                  <span style={{ fontSize: '12px', color: '#8b949e' }}>
                    🔗 Vincular A ↔ B {zonasVinculadas && <strong style={{ color: '#f97316' }}>(ATIVO)</strong>}
                  </span>
                </label>
                
                <div style={{ 
                  fontSize: '11px', color: '#8b949e', 
                  padding: '6px 10px', background: '#161b22', borderRadius: '6px',
                  border: `1px solid ${terminalAtivoZonas === 'A' ? 'rgba(34,197,94,0.3)' : 'rgba(168,85,247,0.3)'}`
                }}>
                  Editando: <strong style={{ color: terminalAtivoZonas === 'A' ? '#22c55e' : '#a855f7' }}>
              ...
              <div style={{ padding: '20px', display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px' }}>
                ...
                <div style={{ 
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                    <div className="input-group">
                      ...
                      <div style={{ position: 'relative' }}>
                        <input
                          ...
                          onChange={(e) => setZonasAtual({...zonasAtual, z1_percent: parseFloat(e.target.value) || 0})}
                          style={{ 
                            width: '100%', padding: '10px 40px 10px 14px', 
                            background: '#161b22', border: `1px solid ${zonasAtual.z1_percent > 85 ? '#f59e0b' : '#30363d'}`, 
                    ...
                    <div className="input-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setZonasAtual({...zonasAtual, z1_tempo: parseFloat(e.target.value) || 0})}
                        style={{ 
                  ...
                  <div style={{ 
                    ...
                    <span style={{ color: '#8b949e' }}>Valor calculado: <strong style={{ color: '#22c55e' }}>
                      {((Math.sqrt(linha.R1**2 + linha.X1**2) * projeto.linha_comprimento) * zonasAtual.z1_percent / 100).toFixed(2)} Ω
                    </strong></span>
                  </div>
                </div>
                ...
                <div style={{ 
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                    <div className="input-group">
                      ...
                      <div style={{ position: 'relative' }}>
                        <input
                          ...
                          onChange={(e) => setZonasAtual({...zonasAtual, z2_percent: parseFloat(e.target.value) || 0})}
                          style={{ 
                            width: '100%', padding: '10px 40px 10px 14px', 
                            background: '#161b22', border: '1px solid #30363d', 
                            borderRadius: '8px', color: '#e6edf3', fontSize: '16px', fontWeight: '600'
                    ...
                    <div className="input-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setZonasAtual({...zonasAtual, z2_tempo: parseFloat(e.target.value) || 0})}
                        style={{ 
                          width: '100%', padding: '10px 14px', 
                          background: '#161b22', border: '1px solid #30363d', 
                          borderRadius: '8px', color: '#e6edf3', fontSize: '16px', fontWeight: '600'
                  ...
                  <div style={{ 
                    ...
                    <span style={{ color: '#8b949e' }}>Valor calculado: <strong style={{ color: '#3b82f6' }}>
                      {((Math.sqrt(linha.R1**2 + linha.X1**2) * projeto.linha_comprimento) * zonasAtual.z2_percent / 100).toFixed(2)} Ω
                    </strong></span>
                  </div>
                </div>
                ...
                <div style={{ 
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                    <div className="input-group">
                      ...
                      <div style={{ position: 'relative' }}>
                        <input
                          ...
                          onChange={(e) => setZonasAtual({...zonasAtual, z3_percent: parseFloat(e.target.value) || 0})}
                          style={{ 
                            width: '100%', padding: '10px 40px 10px 14px', 
                            background: '#161b22', border: '1px solid #30363d', 
                    ...
                    <div className="input-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setZonasAtual({...zonasAtual, z3_tempo: parseFloat(e.target.value) || 0})}
                        style={{ 
                          width: '100%', padding: '10px 14px', 
                          background: '#161b22', border: '1px solid #30363d', 
                          borderRadius: '8px', color: '#e6edf3', 
                  ...
                  <div style={{ 
                    ...
                    <span style={{ color: '#8b949e' }}>Valor calculado: <strong style={{ color: '#f97316' }}>
                      {((Math.sqrt(linha.R1**2 + linha.X1**2) * projeto.linha_comprimento) * zonasAtual.z3_percent / 100).toFixed(2)} Ω
                    </strong></span>
                  </div>
                </div>
                ...
                <div style={{ 
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
                    <div style={{ 
                      width: '36px', height: '36px', 
                      background: zonasAtual.z4_habilitada 
                    ...
                    <div>
                      <h4 style={{ color: zonasAtual.z4_habilitada ? '#a855f7' : '#6b7280', margin: 0, fontSize: '15px' }}>
                        Zona 4 - {zonasAtual.z4_reversa ? 'Reversa' : 'Forward'} (Opcional)
                      </h4>
                      <span style={{ fontSize: '11px', color: '#8b949e' }}>
                        {zonasAtual.z4_reversa 
                    ...
                    <label style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}>
                      <input
                        ...
                        onChange={(e) => setZonasAtual({...zonasAtual, z4_habilitada: e.target.checked})}
                  ...
                  <div style={{ 
                    ...
                    <button
                      onClick={() => setZonasAtual({...zonasAtual, z4_reversa: true})}
                    ...
                    <button
                      onClick={() => setZonasAtual({...zonasAtual, z4_reversa: false})}
                      disabled={!zonasAtual.z4_habilitada}
                      style={{
                        flex: 1, padding: '8px 12px',
                        background: !zonasAtual.z4_reversa ? 'rgba(168,85,247,0.2)' : '#161b22',
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                    <div className="input-group">
                      <label style={{ fontSize: '12px', color: '#8b949e', marginBottom: '6px', display: 'block' }}>
                        Alcance {zonasAtual.z4_reversa ? 'Reverso' : 'Forward'} (% da Linha)
                      </label>
                      <div style={{ position: 'relative' }}>
                        <input
                          type="number"
                          value={zonasAtual.z4_percent}
                          onChange={(e) => setZonasAtual({...zonasAtual, z4_percent: parseFloat(e.target.value) || 0})}
                          disabled={!zonasAtual.z4_habilitada}
                          style={{ 
                            width: '100%', padding: '10px 40px 10px 14px', 
                            background: '#161b22', border: '1px solid #30363d', 
                    ...
                    <div className="input-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setZonasAtual({...zonasAtual, z4_tempo: parseFloat(e.target.value) || 0})}
                        disabled={!zonasAtual.z4_habilitada}
                        style={{ 
                          width: '100%', padding: '10px 14px', 
                          background: '#161b22', border: '1px solid #30363d', 
                  ...
                  <div style={{ 
                    ...
                    borderRadius: '6px',
                    fontSize: '11px', color: zonasAtual.z4_habilitada ? '#d8b4fe' : '#9ca3af'
                  }}>
                    {zonasAtual.z4_reversa ? (
                      <>
                    ...
                    {zonasAtual.z4_habilitada && (
                      <>
                        <br/>
                        <span style={{ color: '#8b949e' }}>Valor calculado: <strong style={{ color: '#a855f7' }}>
                          {((Math.sqrt(linha.R1**2 + linha.X1**2) * projeto.linha_comprimento) * zonasAtual.z4_percent / 100).toFixed(2)} Ω
                        </strong> ({zonasAtual.z4_reversa ? 'REVERSE' : 'FORWARD'})</span>
                      </>
                    )}
                  </div>
                </div>
