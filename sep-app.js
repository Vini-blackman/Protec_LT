...
function SEPApp() {
  ...
  const aplicarPadraoZonas = norma => {
    ...
    setZonasProtecao({
      ...
      z4_tempo: padrao.z4t,
      z4_habilitada: true,
      // Z4 habilitada por padrão em todas as normas
...
<body>
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      background: '#161b22',
      border: `1px solid ${zonasProtecao.z1_percent > 85 ? '#f59e0b' : '#30363d'}`,
      borderRadius: '8px',
      color: '#e6edf3',
      fontSize: '16px',
      fontWeight: '600'
  ...
  }, "%")), zonasProtecao.z1_percent > 85 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '8px',
      padding: '8px 10px',
    ...
    style: {
      width: '36px',
      height: '36px',
      background: zonasProtecao.z4_habilitada ? 'linear-gradient(135deg, #a855f7, #9333ea)' : 'linear-gradient(135deg, #6b7280, #4b5563)',
      borderRadius: '8px',
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
  ...
  }, "Zona 4 - ", zonasProtecao.z4_reversa ? 'Reversa' : 'Forward', " (Opcional)"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '11px',
      color: '#8b949e'
    }
  }, zonasProtecao.z4_reversa ? 'Backup de Barra • Falha de Disjuntor' : 'Sobrealcance adicional • POTT/PUTT')), /*#__PURE__*/React.createElement("label", {
    style: {
      marginLeft: 'auto',
      display: 'flex',
      alignItems: 'center',
  ...
  }, "Alcance ", zonasProtecao.z4_reversa ? 'Reverso' : 'Forward', " (% da Linha)"), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative'
    }
  }, /*#__PURE__*/React.createElement("input", {
    ...
    style: {
      ...
      borderRadius: '6px',
      fontSize: '11px',
      color: zonasProtecao.z4_habilitada ? '#d8b4fe' : '#9ca3af'
    }
  }, zonasProtecao.z4_reversa ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("strong", null, "\uD83D\uDCCB Z4 Reversa:"), " 20% (t\xEDpico 10-25%)", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#8b949e'
    }
  ...
  }, "\uD83D\uDCA1 Usada em esquemas de teleprote\xE7\xE3o permissiva. Dire\xE7\xE3o: mesma que Z1, Z2, Z3.")), zonasProtecao.z4_habilitada && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#8b949e'
    }
  }, "Valor calculado: ", /*#__PURE__*/React.createElement("strong", {
  ...
  }, (Math.sqrt(linha.R1 ** 2 + linha.X1 ** 2) * projeto.linha_comprimento * zonasProtecao.z4_percent / 100).toFixed(2), " \u03A9"), " (", zonasProtecao.z4_reversa ? 'REVERSE' : 'FORWARD', ")"))))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '16px 20px',
      background: 'rgba(22,27,34,0.6)',
